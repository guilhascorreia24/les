# Generated by Django 3.0.3 on 2020-03-05 22:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(max_length=45)),
                ('iduo', models.CharField(db_column='idUO', max_length=45)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Escola',
            fields=[
                ('idescola', models.IntegerField(primary_key=True, serialize=False)),
                ('nome', models.CharField(max_length=45)),
        ...
        migrations.CreateModel(
            name='Horario',
            fields=[
                ('horainicio', models.IntegerField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'horario',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Material',
            fields=[
                ('idmaterial', models.IntegerField(db_column='idMaterial', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Administrador',
            fields=[
                ('utilizador_idutilizador', models.OneToOneField(db_column='Utilizador_idutilizador', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Utilizador')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('espaco_idespaco', models.OneToOneField(db_column='espaco_idespaco', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Espaco')),
            ],
            options={
                'db_table': 'anfiteatro',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('atividade_idatividade', models.OneToOneField(db_column='Atividade_idAtividade', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Atividade')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inscricao_idinscricao', models.OneToOneField(db_column='inscricao_idinscricao', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Inscricao')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transporte_idtransporte', models.OneToOneField(db_column='transporte_idtransporte', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Transporte')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('colaborador_utilizador_idutilizador', models.OneToOneField(db_column='colaborador_Utilizador_idutilizador', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Colaborador')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('coordenador_utilizador_idutilizador', models.OneToOneField(db_column='Coordenador_Utilizador_idutilizador', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='main.Coordenador')),
            ],
            options={
